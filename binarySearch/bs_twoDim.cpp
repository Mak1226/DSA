...
int main()
{
    ...
    case 4:
        cout << "Test Case 1:" << endl;
        cout << "1 4\n3 2" << endl;
        peakElement2D({{1, 4}, {3, 2}});
        cout << "Test Case 2:" << endl;
        cout << "10 20 15\n21 30 14\n7 16 32" << endl;
        peakElement2D({{10, 20, 15}, {21, 30, 14}, {7, 16, 32}});
        break;
    case 5:
        cout << "Test Case 1:" << endl;
        cout << "1 4 9\n2 5 6\n3 8 7" << endl;
        medianSortedMatrix({{1, 4, 9}, {2, 5, 6}, {3, 8, 7}});
        cout << "Test Case 2:" << endl;
        cout << "1 4 9\n2 5 6\n3 8 7" << endl;
        medianSortedMatrix({{1, 3, 8}, {2, 3, 4}, {1, 2, 5}});
        break;
    default:
        break;
    }
